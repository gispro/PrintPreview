...
GeoExt.ux.PrintPreview = Ext.extend(Ext.Container, {
    ...
    /** api: config[formatText] ``String`` i18n */
    formatText: "Format:",
            ...
            "render": function() {
                if (!this.busyMask) {
                    this.busyMask = new Ext.LoadMask(this.getEl(), {
                        msg: locale.printPreview.creatingPdfText
                    });
                }
    ...
    createToolbar: function() {
        var items = [];
        this.printProvider.layouts.getCount() > 1 && items.push(locale.printPreview.paperSizeText, {
            xtype: "combo",
            width: 98,
        ...
        this.printProvider.dpis.getCount() > 1 && items.push(locale.printPreview.resolutionText, {
            xtype: "combo",
            width: 62,
            plugins: new GeoExt.plugins.PrintProviderField({
                printProvider: this.printProvider
        ...
        this.printProvider.formats.getCount() > 1 && items.push(locale.printPreview.formatText, {
            xtype: "combo",
            width: 45,
            plugins: new GeoExt.plugins.PrintProviderField({
                printProvider: this.printProvider
            }),
            store: this.printProvider.formats,
            displayField: "name",
            typeAhead: true,
            mode: "local",
            forceSelection: true,
        ...
        items.push("->", {
            text: locale.printPreview.printText,
            iconCls: "icon-print",
            handler: function(){
    ...
    createForm: function() {
		...
		var titleCfg = {
            ...
            value: this.mapTitle,
            emptyText: locale.printPreview.emptyTitleText,
            margins: "0 5 0 0",
            flex: 1,
            anchor: "100%",
            hideLabel: true,
        ...
        if(this.legend) {
            var legendCheckbox = new Ext.form.Checkbox({
                ...
                boxLabel: locale.printPreview.includeLegendText,
                hideLabel: true,
    ...
    /** private: method[createCommentForm]
     *  :return: ``Ext.form.FormPanel``
     */
    createCommentForm: function() {
        return new Ext.form.FormPanel({
            ...
            items: [{
                ...
                value: this.comment,
                emptyText: locale.printPreview.emptyCommentText,
                hideLabel: true,
                plugins: new GeoExt.plugins.PrintProviderField({
                    printProvider: this.printProvider
                })
